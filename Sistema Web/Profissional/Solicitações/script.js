window.addEventListener('DOMContentLoaded', () => {
    ...
    function abrirPainelAnalise(id) {
        ...
        document.getElementById('detalhe-servico').textContent = item.servico;
        document.getElementById('detalhe-data').textContent = formatarDataBR(item.data);
        document.getElementById('detalhe-hora').textContent = item.hora;
        document.getElementById('detalhe-documento').textContent = item.documento !== "Nenhum" ? `📄 ${item.documento}` : "Nenhum arquivo enviado";
        document.getElementById('detalhe-observacoes').textContent = item.obs;
    ...
    function fecharTodosModais() {
        ...
        modalPendente.classList.remove('active');
        document.getElementById('texto-cancelar').value = '';
        document.getElementById('texto-pendente').value = '';
    ...
    btnFecharAnalisar.addEventListener('click', fecharTodosModais);
    ...
    btnConcluirCancelar.addEventListener('click', () => {
        const texto = document.getElementById('texto-cancelar').value;
        if (!texto.trim()) {
    ...
    btnModalPendente.addEventListener('click', () => {
        modalPendente.classList.add('active');
    });
    ...
    btnConcluirPendente.addEventListener('click', () => {
        const texto = document.getElementById('texto-pendente').value;
        if (!texto.trim()) {
