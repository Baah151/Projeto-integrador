document.addEventListener('DOMContentLoaded', () => {
    ...
    const fecharModalAgendar = () => modalAgendar.classList.remove('active');
    ...
    if (btnFecharEditar) btnFecharEditar.addEventListener('click', () => modalEditar.classList.remove('active'));
    ...
    if (btnCancelarConfirmacao) btnCancelarConfirmacao.addEventListener('click', () => modalConfirmarSalvar.classList.remove('active'));
    ...
    if (btnAbrirExcluir) btnAbrirExcluir.addEventListener('click', () => modalExcluir.classList.add('active'));
    if (btnCancelarExclusao) btnCancelarExclusao.addEventListener('click', () => modalExcluir.classList.remove('active'));
